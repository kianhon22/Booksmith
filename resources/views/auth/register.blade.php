<x-guest-layout>
    <form method="POST" action="{{ route('register') }}" x-data="{ role: 'seller' }">
        @csrf

        <div class="mb-4 p-4 bg-blue-50 dark:bg-blue-900/50 border border-blue-200 dark:border-blue-800 rounded-lg">
            <p class="text-sm text-blue-800 dark:text-blue-200">
                <strong>Register as Seller</strong><br>
        ...
        <div class="mt-4">
            ...
            <textarea id="business_address" name="business_address" rows="2" required
                class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm block mt-1 w-full">{{ old('business_address') }}</textarea>
        ...
        <div class="mt-4">
            ...
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Tell us about your business and the types of books you'll be selling.</p>
        </div>
