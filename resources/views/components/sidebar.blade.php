<div class="fixed inset-y-0 left-0 z-50 w-64 bg-indigo-600 shadow-lg transform lg:translate-x-0">
    ...
    <nav class="flex-1 px-4 py-2 space-y-1 overflow-y-auto">
        <div class="pt-2 pb-2">
            <p class="px-4 text-xs font-semibold text-indigo-100 uppercase tracking-wider">Management</p>
        </div>
        ...
        <div class="pt-4 pb-2">
            <p class="px-4 text-xs font-semibold text-indigo-100 uppercase tracking-wider">Browse</p>
        </div>
