<x-app-layout>
    ...
    >
        <x-slot name="footer">
            <span class="text-sm text-gray-600 dark:text-gray-400">{{ $pendingOrders }} pending</span>
        </x-slot>
    </x-stats-card>
...
@if($lowStockBooks->count() > 0)
    <div class="mb-6">
        <x-alert type="warning">
            <strong>Low Stock Warning:</strong> You have {{ $lowStockBooks->count() }} book(s) with low stock. Consider restocking them.
        </x-alert>
    </div>
@endif
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            @foreach($recentOrders as $order)
                                <div class="flex items-center justify-between py-2 border-b border-gray-200 last:border-0">
                                    ...
                                    <div class="text-right">
                                        <p class="font-medium text-black">RM {{ number_format($order->total, 2) }}</p>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <div class="flex items-center justify-between mb-4">
                        <h3 class="text-lg font-semibold text-black">Recent Books</h3>
                        ...
                        <div class="space-y-3">
                            @foreach($recentBooks as $book)
                                <div class="flex items-center justify-between py-2 border-b border-gray-200 last:border-0">
                                    ...
                                    <div class="text-right">
                                        <p class="font-medium text-black">RM {{ number_format($book->price, 2) }}</p>
