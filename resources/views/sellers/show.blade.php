                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-900">{{ $seller->email }}</p>
                        </div>
                        <div>
                            <p class="text-sm font-medium text-gray-500">Phone</p>
                            <p class="mt-1 text-sm text-gray-900">{{ $seller->phone }}</p>
                        </div>
                        <div>
                            <p class="text-sm font-medium text-gray-500">Business Name</p>
                            <p class="mt-1 text-sm text-gray-900">{{ $seller->business_name }}</p>
                        </div>
                        <div class="md:col-span-2">
                            <p class="text-sm font-medium text-gray-500">Business Address</p>
                            <p class="mt-1 text-sm text-gray-900">{{ $seller->business_address }}</p>
                        </div>
                        <div class="md:col-span-2">
                            <p class="text-sm font-medium text-gray-500">Business Description</p>
                            <p class="mt-1 text-sm text-gray-900">{{ $seller->business_description }}</p>
                        </div>
                        <div>
                        ...
                        @if($seller->approved_at)
                            <div>
                                ...
                                <p class="mt-1 text-sm text-gray-900">{{ $seller->approved_at->format('M d, Y') }}</p>
                            </div>
                        @endif
                    </div>
                </div>
                    ...
                    @if($seller->orders->count() > 0)
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @foreach($seller->orders->take(10) as $order)
                                        <tr>
