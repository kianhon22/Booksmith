                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select id="condition" name="condition" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" required>
                            ...
                            <option value="used_like_new" {{ old('condition') == 'used_like_new' ? 'selected' : '' }}>Used - Like New</option>
                            <option value="used_good" {{ old('condition') == 'used_good' ? 'selected' : '' }}>Used - Good</option>
                            <option value="used_acceptable" {{ old('condition') == 'used_acceptable' ? 'selected' : '' }}>Used - Acceptable</option>
                        </select>
                    ...
                    <div>
                        ...
                        <x-text-input id="publication_year" name="publication_year" type="number" min="1000" :max="date('Y')" class="mt-1 block w-full" :value="old('publication_year')" />
                    ...
                    <div>
                        ...
                        <x-text-input id="language" name="language" type="text" class="mt-1 block w-full" :value="old('language', 'English')" required />
                    ...
                    <div>
                        ...
                        <x-text-input id="pages" name="pages" type="number" min="1" class="mt-1 block w-full" :value="old('pages')" />
