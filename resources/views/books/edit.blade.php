<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center">
            ...
            <h2 class="text-2xl font-bold text-black dark:text-gray-100">Edit Book: {{ $book->title }}</h2>
        </div>
    </x-slot>
            ...
            <form method="POST" action="{{ route('books.update', $book) }}" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <x-text-input id="stock" name="stock" type="number" min="0" class="mt-1 block w-full" :value="old('stock', $book->stock)" required />
