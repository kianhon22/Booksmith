    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <div class="flex space-x-2">
                <a href="{{ route('book-management.edit', $book) }}" class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-700">
                    Edit
                </a>
                        ...
                        <div class="md:col-span-2 space-y-4">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-2xl font-bold text-indigo-600">${{ number_format($book->price, 2) }}</p>
                                </div>
                                <div>
                                    <p class="text-sm font-medium text-gray-500">Stock</p>
                                    <p class="mt-1 text-sm text-gray-900">{{ $book->stock }} available</p>
                                </div>
                                <div>
                                    <p class="text-sm font-medium text-gray-500">Publisher</p>
                                    <p class="mt-1 text-sm text-gray-900">{{ $book->publisher ?? 'N/A' }}</p>
                                </div>
                                <div>
                                    <p class="text-sm font-medium text-gray-500">Publication Year</p>
                                    <p class="mt-1 text-sm text-gray-900">{{ $book->publication_year ?? 'N/A' }}</p>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-gray-900">{{ $book->orderItems()->count() }} orders</p>
                                </div>
                            </div>
                            <div>
